...
out_file = r"c:\Users\hdy56\OneDrive\바탕 화면\파워빌드분석\dir_dump.txt"
with open(out_file, "w", encoding="utf-8") as f:
    for name, etype, esize in entries:
        f.write("Name: '{}', Type: {}, Size: {}\n".format(name, etype, esize))

print("Dumped {} entries to {}".format(len(entries), out_file))
