...
**배치1 스코프 확정**: 소실 15노드 중 **14노드**(AJR74962904-16-1 제외=BOM USE_QTY 0=nx 0=이미 일치, 실손실 아님). 14노드는 BOM==그리드 일치라 소스 무관 동일 타깃. baseline 43품목 충돌 **없음**. 노드타입: nx연결됨4·dropped SUB3·nx제품有3·nx BOM전무3(AGR30801603/604·AJR30113102=구조부재 개별조사)·CS 2부모1(AJR30133604-12-1). **쓰기 미실행, 소스 확정 대기.**
