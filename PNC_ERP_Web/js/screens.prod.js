...
SCREEN.prodsheet=(host)=>{
  ...
  const render=(bodyOnly)=>{
    ...
    host.innerHTML=`
     ...
     <div class="page-title" style="flex:0 0 auto">생산전표출력관리 <span style="font-size:12px;color:var(--muted);font-weight:400">w_pr_input_490 · 전표 기준 가간판/제품스티커 발행</span></div>
