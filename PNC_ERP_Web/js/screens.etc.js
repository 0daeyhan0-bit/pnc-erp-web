       ...
       <div style="flex:1;min-width:560px;display:flex;gap:16px;align-items:flex-start;flex-wrap:wrap">
         ...
         <div style="flex:1;min-width:280px">
           <table class="tbl" style="${TS}"><colgroup><col style="width:60px"><col><col style="width:112px"><col style="width:64px"></colgroup><tbody>
             ...
             <tr><td rowspan="7" style="text-align:center;vertical-align:middle;font-weight:700;background:#eef2f8;color:#1c47a0;border-top:2px solid #555;border-right:2px solid #555">매입비율</td><td style="border-top:2px solid #555">매입</td><td class="num" style="border-top:2px solid #555">${wonI(F.ratio.pur)}</td><td class="num" style="border-top:2px solid #555"><b>${F.ratio.pur_pct}%</b></td></tr>
             <tr><td>실매입(조정전)</td><td class="num">${wonI(F.ratio.net)}</td><td class="num"><b>${F.ratio.net_pct}%</b></td></tr>
             <tr><td style="padding-left:14px">재고조정 − 생산가공</td><td class="num" style="color:${(F.jaego&&F.jaego.gagong<0)?'#c0392b':'#1c7c3a'}">${wonI(F.jaego?F.jaego.gagong:0)}</td><td></td></tr>
             <tr><td style="padding-left:14px">재고조정 − 생산용접</td><td class="num" style="color:${(F.jaego&&F.jaego.weld<0)?'#c0392b':'#1c7c3a'}">${wonI(F.jaego?F.jaego.weld:0)}</td><td></td></tr>
