...
def lglme_copy(payload: dict = Body(...)):
    ...
    try:
        ...
        cur.execute("""INSERT INTO nx.lg_lme_gagong(apply_ym,gubun,diam,thick,vn_gagong,vn_prem,vn_mul,vn_naeryuk,cn_gagong,cn_prem,cn_mul,cn_naeryuk,duty_vn,duty_cn,mix_cn,mix_vn,calc_mode,kr_gagong,cn_fix)
            SELECT ?,gubun,diam,thick,vn_gagong,vn_prem,vn_mul,vn_naeryuk,cn_gagong,cn_prem,cn_mul,cn_naeryuk,duty_vn,duty_cn,mix_cn,mix_vn,calc_mode,kr_gagong,cn_fix FROM nx.lg_lme_gagong WHERE apply_ym=?""", to, fr)
