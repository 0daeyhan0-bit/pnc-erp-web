...
_HRCHK = {"1": "연차", "2": "오전반차", "8": "오후반차", "3": "조퇴", "7": "결근",
          "20": "잔업1", "21": "잔업1.5", "22": "잔업2", "23": "잔업2.5", "24": "잔업3", "25": "잔업3.5"}
# 소스 dw_pr_worktime_001_t2(4~6은 빈 라벨=정상).
# ★2026-08-23 반차를 오전/오후로 분리. 레거시 HR_CHECK_POINT 는 4·5·6·10~14 를 이미
#   다른 의미로 쓰고 있어(4=38,374건 등) 그 코드는 못 쓴다. '2'(레거시 0건)=오전반차,
#   '8'(레거시 미사용)=오후반차 로 배정. 시간규칙 오전 0800~1200 / 오후 1300~1700(각 4h).
# ★2026-09-07 '7'=결근 추가 — 새 코드를 만들지 않고 **레거시 코드를 그대로 쓴다**.
#   레거시 근무공수등록 드롭다운에 이미 '결근'이 있다(사용자 확인).
#   실측 역산: 코드7 = START/END 0000~0000 · WORK_HR 0 · 4,707건,
#             REMARKS 에 '결근'·'병가'·'퇴사'·'예비군'·'교육'.
#   (코드1 도 0000~0000 이나 비고가 '월차'·'반차'·'라인휴무' 계열 → 우리 '연차'와 같은 축)
#   ※위 2026-08-23 주석이 7 을 "다른 의미로 사용중"이라 적었으나, 실측하니 그 의미가 결근이었다.
def _hrchk(v):
