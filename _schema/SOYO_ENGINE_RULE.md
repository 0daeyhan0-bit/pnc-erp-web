...
| 4 | `ready.py:106`(setcheck)·`kitting.py:89/296/832` | 키팅 물량/충당 | explode walker | ✅**kitting_grid(89) 완료(2026-09-08)**: 투입파트 키셋 = 신규 walker `kitting_gpcs`(계획품목 VIR-트리 WH_GAGONG=whp 엣지의 (item,gagong_proc) 집합). 미러 pr_m_item_bom 재귀CTE 대체(컷오버 안전 §1-9-1). ★**출력레벨 diff0** 검증(kit_out_verify): 표시행 636쌍 유지 동일(미러만/walker만=0/0). ☐남음=ready.py:106·kitting 296/832 |
