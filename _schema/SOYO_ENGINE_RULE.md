...
| 4 | `ready.py:106`(setcheck)·`kitting.py:89/296/832` | 키팅 물량/충당 | explode walker | ✅**kitting_grid(89) 완료(2026-09-08)**: 투입파트 키셋 = 신규 walker `kitting_gpcs`. 미러 pr_m_item_bom 재귀CTE 대체(§1-9-1). ★출력레벨 diff0(kit_out_verify 636/636). ✅**재고충당 상향롤업(kitting_grid T_SUB_CTE + plan_part410 #tms4) 완료(2026-09-08)**: 신규 walker `stock_flow_rollup`(창고재고 시드→bom_line 하향전개·각레벨 CONVERT(int)절사·fixstk[(부모,자식)]=Flow×use). 미러 pr_m_item_bom 재귀CTE 대체. ★**fixstk diff0 2318/2318**(stkroll_verify). 앵커 창고집계(midstk/matwh/prwh)는 비재귀 SQL 유지. ☐남음=ready.py:106 |
