...
with open(r"c:\Users\hdy56\OneDrive\바탕 화면\파워빌드분석\test_layout_result.txt", "w", encoding="utf-8") as f:
    for name, comments, etype, esize in entries[:20]:
        buf_len = 5 * 1024 * 1024
...
print("Done writing to test_layout_result.txt")
